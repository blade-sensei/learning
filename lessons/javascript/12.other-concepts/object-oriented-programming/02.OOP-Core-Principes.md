...
- C'est le POLYMORPHISME, pour le maitre le faucon, l'aigle, le chouette, remplacent un "oiseau"
- Ok, au passage "petit" avantage, d'avoir un spectacle "générique", semaine prochaine, le zoo, peut rajouter des Condors, le maitre sera capable de faire voler l'oiseau sans rien changer dans ses compétences
